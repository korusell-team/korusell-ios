        ...
        TrackableScrollView(showIndicators: false, contentOffset: $offset) {
            VStack(spacing: 0) {
                ...
                VStack(alignment: .leading, spacing: 10) {
                    ...
                    Text("Если Вы обнаружили контент (фото, текст, ссылки), который нарушает Политику Нежелательного Контента, пожалуйста, напишите мне на guagetru.bla@gmail.com. Также Вы можете заблокировать Место или пожаловаться на него нажав на три точки в правом верхнем углу экрана")
                        .font(light14f)
                        .foregroundColor(.gray700)
                        .multilineTextAlignment(.center)
